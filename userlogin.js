        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            loginForm.addEventListener('submit', (event) => {
                ...
                if (storedUser) {
                    ...
                    if (user.email === email && password === 'password') { // In real case  compare hashed password.
                        ...
                        setTimeout(() => {
                         ...
                         formErrorResponse('login-error-message', 'Invalid credentials');
                    }
                } else {
                    formErrorResponse('login-error-message', 'User not found. Please sign up.');
                }
            });
        });
    </script>
